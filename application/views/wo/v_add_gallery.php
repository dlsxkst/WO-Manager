            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
               <?php 
                ...
                echo form_open_multipart('am/add_gallery/'.$gallery->id_gallery)
                ...
                ?>
                  ...
                  <div class="row">
                   ...
                   <div class="form-group">
                       ...
                       <a href="<?= base_url('am/gallery'); ?>" class="btn btn-md btn-success">Kembali</a>
                  </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a href="<?= base_url('am/delete_gambar/'.$k->id_gallery .'/'. $k->id_gambar); ?>" class="btn btn-danger">Delete</a>
            </div>
