...
<div class="col-md-8">
  <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                echo form_open_multipart('am/edit_profile/');
              ...
              <div class="row">
                <div class="col-sm-6">
                   <div class="form-group">
                        ...
                        <input class="form-control" name="nama_toko" value="<?= $wo->nama_toko; ?>">
                 ...
                 <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="username" value="<?= $wo->username; ?>">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                        <label>Email</label>
                        <input class="form-control" name="email" value="<?= $wo->email; ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="no_telp" value="<?= $wo->no_telp; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="no_rek" value="<?= $wo->no_rek; ?>">
                 ...
                 <div class="row">
                   <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" id="" cols="30" rows="5"><?= $wo->deskripsi; ?></textarea>
                   ...
                   <div class="col-sm-6">
                      <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" class="form-control" id="" cols="30" rows="5"><?= $wo->alamat; ?></textarea>
                  ...
                  <div class="col-sm-6 text-center">
                    <div class="form-group">
                      <img src="<?= base_url('assets/foto/'.$wo->gambar); ?>" id="gambar_load" alt="" width="150px">
                    </div>
                  </div>
                  </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
               <?php 
                ...
                echo form_open('am/edit_profile/');
