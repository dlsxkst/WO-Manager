<div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Gambar Paket: <?= $paket->nama_paket; ?></h3>
              ...
              <div class="card-body">
               <?php 
                ...
                echo form_open_multipart('gambarpaket/add/'.$paket->id_paket)
                ...
                ?>
                  ...
                  <div class="row">
                   ...
                   <div class="form-group">
                       ...
                       <a href="<?= base_url('gambarpaket'); ?>" class="btn btn-md btn-success">Kembali</a>
                  </div>
               ...
               <div class="row">
                <?php foreach($gambar as $g) : ?>
                  <div class="col-sm-3 text-center">
                        <div class="form-group">
                          <img src="<?= base_url('assets/gambarpaket/'.$g->gambar); ?>" id="gambar_load" alt="" width="250px" height="200px">
                        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group text-center">
                          <img src="<?= base_url('assets/gambarpaket/'.$k->gambar); ?>" id="gambar_load" alt="" width="200px" height="150px">
              </div>
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a href="<?= base_url('gambarpaket/delete/'.$k->id_paket .'/'. $k->id_gambar); ?>" class="btn btn-danger">Delete</a>
            </div>
