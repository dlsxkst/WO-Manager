...
<div class="container">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Register a new Wedding Organizer</p>
                 ...
                 <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_toko" value="<?= set_value('nama_pelanggan'); ?>">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
