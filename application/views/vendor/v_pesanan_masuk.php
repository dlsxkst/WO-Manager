    ...
    ?>
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                ...
                <!--   <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-four-messages-tab" data-toggle="pill" href="#dikirim" role="tab" aria-controls="custom-tabs-four-messages" aria-selected="false">Dikirim</a>
                  </li> -->
                  <li class="nav-item">
              ...
              <div class="card-body">
                 <?php 
                  ...
                  $jml = $this->db->query("SELECT * FROM `tb_transaksi` WHERE id_vendor='$id_vendor'")->num_rows();
                   ?>
