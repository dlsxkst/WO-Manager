                  ...
                  <?php $no=1; foreach($gallery as $k) :  ?>
                   <tr>
                     ...
                     <td class="text-center">
                      <a href="<?= base_url('vendor/add_gallery/'. $k->id_gallery); ?>" class="btn btn-success btn-sm"><i class="fas fa-plus"> Add Gambar</i></a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open_multipart('kategori/add_gallery_vendor'); ?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="form-control" name="deskripsi"></textarea> 
                      ...
                      <div class="form-group">
                          <label>Gambar</label>
                          <input type="file" class="form-control" name="gambar" id="preview_gambar1">
                      </div>
                 
                  <!--   <div class="form-group">
                      <img src="<?= base_url('assets/gambar/no-image.png'); ?>" id="gambar_load1" alt="" width="150px">
                    </div>
                  -->
            </div>
      ...
      <?php foreach($gallery as $k) :  ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
           ...
           <div class="modal-body">
              <?php echo form_open_multipart('kategori/edit_gallery_vendor/'. $k->id_gallery); ?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <!--  <div class="form-group">
                      <img src="<?= base_url('assets/gambar/no-image.png'); ?>" id="gambar_load2" alt="" width="150px">
                    </div>
                  -->
            </div>
            <div class="modal-footer justify-content-between">
...
<?php foreach($gallery as $k) :  ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              <a href="<?= base_url('kategori/delete_gallery_vendor/'. $k->id_gallery); ?>" class="btn btn-danger">Delete</a>
            </div>
