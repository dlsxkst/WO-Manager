               ...
               <div class="col-md-10 offset-md-1">
                  <div class="row">
                            <div class="col-2">
                                <div class="form-group">
                                    <label>Kota</label>
                                  <input list="kota" type="text" class="form-control" name="kota" placeholder="Pilih Kota" autocomplete="none" required>
                                     <datalist id="kota">
                                  ...
                                  <!--  <select class="form-control" name="kota" style="width: 100%;" required="">
                                    ...
                                    <!-- <input list="add_charge" type="text" class="form-control" name="kota" autocomplete="none" required>
