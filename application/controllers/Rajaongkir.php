...
class Rajaongkir extends CI_Controller {
	...
	private $api_key = '5bd0e2e93157df22370efb902f3c4fbb';
		...
		if ($err) {
		  ...
		  //echo $response;
			...
			foreach ($data_paket as $key => $value) {
				echo "<option value='" . $value['service'] . "' ongkir='" . $value['cost'][0]['value'] * 10 . "' estimasi='" . $value['cost'][0]['etd'] . " Hari'>";
				echo $value['service'] . " | Rp. " . $value['cost'][0]['value'] *10 . " | Estimasi " . $value['cost'][0]['etd'] . " Hari";
				echo "</option>";
